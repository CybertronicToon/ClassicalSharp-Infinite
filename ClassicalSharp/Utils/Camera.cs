...
namespace ClassicalSharp {
	...
	public abstract class Camera {
		...
		public virtual void AdjCamChunk(out Matrix4 camAdj) {
			camAdj = Matrix4.Identity;
		}
	...
	public abstract class PerspectiveCamera : Camera {
		...
		public override void AdjCamChunk(out Matrix4 camAdj) {
			int curChunkX = 4;
			int curChunkY = 4;
			...
			curChunkX -= 4;
			curChunkY -= 4;
			int adjCamX = curChunkX * 16;
			int adjCamZ = curChunkY * 16;
			Matrix4.Translate(out camAdj, adjCamX, 0, adjCamZ);
		}
